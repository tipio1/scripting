...
function mysql_backup_list ()
{
	...
	mysqlshow |cut -d " " -f2 |grep [a-z\|A-Z\|0-9] >/$MYSQL_LOCAL_ROUTE/$MYSQL_DB_LIST
...
function do_mysql_backup (){} # execute the complete process integrating the other functions
# ¡ noos gnimoc
